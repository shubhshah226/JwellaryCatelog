...
import { Catalog, Enquiry, LeadItem, Product } from '@common/models/dashboard.model';
...
export class VendorDataService {
  ...
  /** POST /catalog/createCatalog â€” requires at least one product id. */
  createCatalog(
    name: string,
    productIds: string[],
    opts?: {
  ...
  /**
   * logoUri from businessProfile is s3://â€¦ (not browser-loadable).
